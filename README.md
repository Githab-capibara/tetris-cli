...
Проект содержит **1030 модульных и интеграционных тестов**, покрывающих все компоненты:
...
### Текущая версия: 23.96.6 (2026-03-17)
...
2. Изучите [USER_GUIDE.md](docs/USER_GUIDE.md) для решения распространённых проблем
3. Посмотрите [ARCHITECTURE.md](docs/ARCHITECTURE.md) для технических деталей
