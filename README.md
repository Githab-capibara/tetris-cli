...
Проект содержит **1968 модульных и интеграционных тестов** (1846 + 122 doctest), покрывающих все компоненты, включая тесты для исправлений аудита кода, комплексной проверки исправлений и архитектурные тесты:
