...
Проект содержит **1863 модульных и интеграционных тестов** (1846 в lib + 75 в bin + 26 doc-тестов), покрывающих все компоненты, включая тесты для 32 исправлений аудита кода и 141 новый тест комплексной проверки исправлений:
