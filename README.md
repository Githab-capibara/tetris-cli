...
| Модуль | Описание |
|--------|----------|
| `main.rs` | Точка входа, меню, выбор режима, таблица лидеров, статистика |
| `game.rs` | Игровой цикл, логика, Hold, Sprint, статистика, уровни |
| `tetromino.rs` | Типы фигур, вращение, 40 тестов |
| `io.rs` | Ввод/вывод, терминал, отрисовка |
| `highscore.rs` | Рекорды, таблица лидеров, хеширование |
