...
Проект содержит **1622 модульных и интеграционных тестов**, покрывающих все компоненты, включая тесты для 32 исправлений аудита кода:
...
### Текущая версия: 23.96.19 (2026-03-22)
