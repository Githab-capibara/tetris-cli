...
- Валидация имён в таблице лидеров (фильтрация символов)

**Исправлено:**
- Критическая ошибка в генерации хеша (`get_random_hash()`)
- Зависимость `getrandom` удалена как неиспользуемая
