...
- **Тестируемость**: 1093 модульных и интеграционных тестов
...
| u256 | 0.1.0 | 256-битные числа для хеширования |
...
**Документация актуальна для версии 23.96.7**
