...
Проект содержит **1160+ модульных и интеграционных тестов**, покрывающих все компоненты, включая тесты для исправлений безопасности:
...
- [ ] Все тесты проходят (1160+ тестов)
