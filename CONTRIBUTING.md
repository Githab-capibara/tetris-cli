...
Проект содержит **1085+ модульных и интеграционных тестов**, покрывающих все компоненты, включая тесты для исправлений безопасности:
...
- [ ] Все тесты проходят (1085+ тестов)
