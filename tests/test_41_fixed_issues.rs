...
//!
//! ## ВНИМАНИЕ: Тесты анализа исходного кода
//!
//! Многие тесты в этом файле читают исходные файлы проекта напрямую
//! (через std::fs::read_to_string) и проверяют наличие определённых
//! строк, паттернов или структур в коде. Такие тесты намеренно
//! «хрупкие» (intentionally fragile) — они могут сломаться при
//! рефакторинге, переименовании файлов или изменении структуры кода.
//!
//! Это ожидаемое поведение: данные тесты предназначены для верификации
//! конкретных архитектурных решений и исправлений, и их поломка
//! сигнализирует о потенциальном изменении в архитектуре, которое
//! требует ручной проверки.
//!
//! НЕ ПЫТАЙТЕСЬ «ПОЧИНИТЬ» ЭТИ ТЕСТЫ ПЕРЕНОСОМ ФАЙЛОВ — они должны
//! проверять именно те пути к исходному коду, которые указаны.
//!
