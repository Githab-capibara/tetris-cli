...
#[allow(dead_code)] // Зарезервировано для будущего рефакторинга
const MENU_TITLE_X: u16 = 11; // Позиция заголовка "Т Е Т Р И С"
#[allow(dead_code)]
const MENU_AUTHOR_X: u16 = 11; // Позиция автора
#[allow(dead_code)]
const MENU_CONTROLS_X: u16 = 11; // Позиция заголовка управления
#[allow(dead_code)]
const MENU_RECORD_X: u16 = 11; // Позиция рекорда

/// Позиции элементов меню (Y координаты)
#[allow(dead_code)]
const MENU_TITLE_Y: u16 = 3; // Заголовок
#[allow(dead_code)]
const MENU_RECORD_Y: u16 = 21; // Рекорд
