...
//!
//! ## PROB-124: Дублирование re-export с core/mod.rs
//! Этот модуль делегирует типы из `crate::core` для обратной совместимости.
//! Источник истины: `crate::core`. Данный модуль НЕ удаляется для предотвращения
//! breaking change — внешний код может импортировать типы отсюда.
//!
//! ## Структура модуля
