...
mod tests {
    ...
    fn test_random_hash_generation() {
        ...
        // Хеш должен быть длиной 62 hex символа (31 байт в hex = 62 символа)
        // При 32 байтах получается 64 hex символа, но формат {:x} не добавляет ведущие нули
        assert!(hash1.len() >= 60, "Хеш должен быть минимум 60 символов");
        assert!(hash2.len() >= 60, "Хеш должен быть минимум 60 символов");
