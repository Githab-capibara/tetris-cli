...
impl BagGenerator {
    ...
    ///
    /// Оптимизация: использует clear() + extend() вместо нового Vec
    /// для повторного использования выделенной памяти.
    fn fill_bag(&mut self) {
        // Оптимизация: очищаем существующий вектор вместо создания нового
        self.bag.clear();
        self.bag.extend([
            ShapeType::T,
            ShapeType::L,
