...
fn test_extended_x_axis_boundaries() {
    ...
    for _ in 0..10 {
        if state2.can_move_curr_shape_direction(Direction::Right) {
...
fn test_extended_l_piece_full_rotation() {
    ...
    assert!(
        rotation_count >= 1,
        "L-фигура должна вращаться хотя бы 1 раз"
    );
...
fn test_extended_j_piece_full_rotation() {
    ...
    assert!(
        rotation_count >= 1,
        "J-фигура должна вращаться хотя бы 1 раз"
    );
...
fn test_extended_s_piece_full_rotation() {
    ...
    assert!(
        rotation_count >= 1,
        "S-фигура должна вращаться хотя бы 1 раз"
    );
...
fn test_extended_z_piece_full_rotation() {
    ...
    assert!(
        rotation_count >= 1,
        "Z-фигура должна вращаться хотя бы 1 раз"
    );
...
fn test_extended_i_piece_full_rotation() {
    ...
    assert!(
        rotation_count >= 1,
        "I-фигура должна вращаться хотя бы 1 раз"
    );
...
fn test_extended_counter_clockwise_rotation() {
    ...
    assert!(
        rotation_count >= 1,
        "Фигура должна вращаться против часовой хотя бы 1 раз"
    );
...
fn test_extended_alternating_rotation() {
    ...
    assert!(
        rotation_count >= 1,
        "Фигура должна вращаться минимум 1 раз при чередовании"
    );
