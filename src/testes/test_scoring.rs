...
/// Тест 8: Проверка что очки за фигуру не отрицательные
#[test]
fn test_scoring_piece_non_negative() {
    assert!(PIECE_SCORE_INC >= 0, "Очки за фигуру не должны быть отрицательными");
}
