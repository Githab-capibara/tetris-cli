...
//! 10. Добавлена константа `LOSE_THRESHOLD_Y`
...
mod tests {
    ...
    // =========================================================================
    // ===== Проблема 10: LOSE_THRESHOLD_Y =====
    // =========================================================================
    // Было: магическое число в проверке проигрыша
    // Исправление: добавлена именованная константа LOSE_THRESHOLD_Y

    /// Тест 10.1: Проверяем значение константы LOSE_THRESHOLD_Y.
    /// Константа должна быть равна 1 (верхняя граница поля).
    #[test]
    ...
    /// Значение должно быть на границе допустимой зоны.
    #[test]
