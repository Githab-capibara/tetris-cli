...
//!
//! Основной модуль криптографии. Подмодули: hmac, validator.
//!
...
//! через crate `subtle`. Это предотвращает атаки по времени выполнения.
//!
//! ## Генерация соли
//! `generate_salt()` использует криптографически стойкий генератор случайных
//! чисел (`OsRng`) для создания уникальной соли 256 бит.
//!
...
mod crypto_tests {
    ...
    // =========================================================================
    // Примечание: базовые HMAC-тесты находятся crypto/hmac.rs.
