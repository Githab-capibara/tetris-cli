...
/// Сгенерировать случайную соль из 32 шестнадцатеричных символов (128 бит).
///
/// Используется криптографически стойкий генератор случайных чисел.
/// Возвращает строку вида "a3f7b2c1d4e5f6789012345678901234"
fn get_random_hash() -> String {
    let mut rng = thread_rng();
    // Генерируем 16 случайных байт (128 бит) и конвертируем в hex
    (0..16)
