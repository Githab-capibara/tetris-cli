...
#[test]
fn test_save_error_handling_correct() -> io::Result<()> {
...
#[test]
fn test_load_error_handling_correct() -> io::Result<()> {
...
#[test]
fn test_temporary_files_handling() -> io::Result<()> {
    // Используем относительный путь
...
#[test]
fn test_invalid_json_error_handling() -> io::Result<()> {
