...
//!
//! ## PROB-118: Модульная организация
//! Файл содержит 1100+ строк: структура `ControlsConfig`, методы, валидация, маппинг клавиш.
//!
//! # Audit 2026-04-12, Issue 5.5
//! Текущая архитектура: монолитный модуль без разбиения на подмодули.
//! Это осознанное решение для сохранения обратной совместимости импортов `crate::controls::*`.
//! Разбиение на подмодули возможно в будущих версиях при необходимости рефакторинга.
//!
//! ## Структура файла:
//! - Секция 1: `ControlsConfig` структура и геттеры
//! - Секция 2: Сохранение/загрузка конфигурации (HMAC подпись)
//! - Секция 3: Валидация конфигурации
//! - Секция 4: Маппинг клавиш в игровые действия
//! - Секция 5: Тесты
//!
