...
//! 1. `state.rs` - базовые структуры и константы
//! 2. `mode_trait.rs` - трейты режимов
//! 3. `access.rs` - трейты доступа
//! 4. `view.rs` - представление для отрисовки
//! 5. `logic/` - игровая логика
//! 6. `scoring/` - система очков
//! 7. `render/` - отрисовка
//! 8. `cycle.rs` - игровой цикл (использует все модули)
//!
