...
impl GameStats {
    ...
    #[must_use]
    #[inline]
    pub const fn t_pieces(&self) -> u32 {
        self.t_pieces
    }
    ...
    #[must_use]
    #[inline]
    pub const fn l_pieces(&self) -> u32 {
        self.l_pieces
    }
    ...
    #[must_use]
    #[inline]
    pub const fn j_pieces(&self) -> u32 {
        self.j_pieces
    }
    ...
    #[must_use]
    #[inline]
    pub const fn s_pieces(&self) -> u32 {
        self.s_pieces
    }
    ...
    #[must_use]
    #[inline]
    pub const fn z_pieces(&self) -> u32 {
        self.z_pieces
    }
    ...
    #[must_use]
    #[inline]
    pub const fn o_pieces(&self) -> u32 {
        self.o_pieces
    }
    ...
    #[must_use]
    #[inline]
    pub const fn i_pieces(&self) -> u32 {
        self.i_pieces
    }
    ...
    #[must_use]
    #[inline]
    pub const fn combo_counter(&self) -> u32 {
        self.combo_counter
    }
    ...
    #[must_use]
    #[inline]
    pub const fn end_time(&self) -> Option<Instant> {
        self.end_time
    }
