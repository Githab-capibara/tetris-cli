...
//!
//! TODO (#архитектура): StringCache в настоящее время используется только в тестах.
//! Необходимо завершить миграцию на использование кэшированных строк в GameState
//! или удалить этот модуль если он не нужен.
//!
//! ## Статус использования
//! В основном коде используется встроенное кэширование в GameState.
//! Этот модуль экспортируется для обратной совместимости и тестов.
