...
///
/// Включает: Goto(x,y) ~15 байт, Fg/Bg цвета ~30 байт, Reset ~15 байт.
/// Рассчитано экспериментально на основе максимальной длины escape-последовательностей
/// в crate `termion` для 256-цветного режима.
