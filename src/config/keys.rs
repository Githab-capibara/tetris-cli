...
pub const CONTROLS_HMAC_KEY: &str = "tetris-cli-test-hmac-key-2026";
...
/// # Значение по умолчанию для тестов
/// Для тестирования используется безопасное тестовое значение.
pub const LEADERBOARD_HMAC_KEY: &str = "tetris-cli-test-hmac-key-2026";
...
/// # Значение по умолчанию для тестов
/// Для тестирования используется безопасное тестовое значение.
pub const SAVE_DATA_HMAC_KEY: &str = "tetris-cli-test-hmac-key-2026";
