...
impl Application {
    ...
    pub fn new() -> Result<Self, GameError> {
        ...
        //
        // Audit 2026-04-12, Issue 8.5: Переменная errors содержит детали ошибок валидации,
        // но используется только для подсчёта количества (errors.len()). Это осознанное решение:
        // детальные сообщения об ошибках уже выведены функцией validate_all_keys() через log_warn!,
        // здесь мы только суммируем количество проблем для пользователя.
